...
//Function used to send the content of the transmit buffer (the last 2/3 lines) to a new connecting client.
...
void WiFiTerm::webSocketEvent(uint8_t num, WStype_t type, uint8_t *payload, size_t length)
{
  switch(type)
  {
    case WStype_CONNECTED:
      //term.sendPrevious(num); //Removed because it's an unwanted behaviour
      break;
    case WStype_TEXT:
